...
public class give_RideRequest extends AppCompatActivity {
    ...
    private void retrieveRideRequestsFromFirebase() {
        ...
        DatabaseReference rideRequestsRef1 = FirebaseDatabase.getInstance().getReference().child("give_ride_requests");
        rideRequestsRef1.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
